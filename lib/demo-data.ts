...
export const demoOrders: Order[] = [
  ...
  },
  {
    ...
    tip: 0,
    total: 336.4,
    kitchen_sent_at: new Date(Date.now() - 6 * 60 * 1000).toISOString(),
    items: [
      { id: 'oi6', order_id: 'o3', menu_item_id: 'm3', name: 'Tacos al pastor', quantity: 2, unit_price: 85, kitchen_status: 'pending' },
